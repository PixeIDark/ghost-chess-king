...
function Timer({ time, player, playerColor }: TimerProps) {
  ...
  return (
    <div
      className={`rounded-lg border px-6 py-4 text-center transition ${
        isCurrentPlayer ? "border-blue-500 bg-blue-500/10" : "border-gray-600 bg-gray-700/50"
    ...
    >
      ...
      <p
        className={`mt-2 font-mono text-3xl font-bold ${
          isLowTime && isCurrentPlayer ? "text-red-400" : isCurrentPlayer ? "text-blue-300" : "text-gray-300"
        }`}
      >
